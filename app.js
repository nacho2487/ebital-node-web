...
var result = UglifyJS.minify([
  './src/client/js/lib/jquery.min.js',
  './src/client/js/lib/bootstrap.min.js',
  './src/client/js/lib/lightbox.min.js',
  './src/client/js/main.js',
  './node_modules/intersection-observer/intersection-observer.js',
  './src/client/js/lazyLoad.js',
]);
...
app.use(i18n.init);
app.use(
  express.static(path.join(__dirname, './src/client'), { maxAge: 31557600000 })
);
app.use(
